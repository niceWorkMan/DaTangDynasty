import { _decorator, Component, Node, Size, Sprite, SpriteAtlas, UITransform } from 'cc';
...
export class AtlasManager extends Component {
    ...
    public loadBackGround(key,spriteName){
        this._netResBundle.load(
            "spriteRes/"+key+"/"+key+"BackGround",
            SpriteAtlas,
            (err, atlas) => {
              if (err) {
